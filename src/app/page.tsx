      ...
      <section id="brand-story" className="py-20 bg-[#080808] border-t border-[#F0EFE7]/5 px-6">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          <p className="text-xs text-[#F0EFE7]/70 leading-relaxed uppercase max-w-2xl font-light">
            Lunar Thrift is a dedicated archive filtering decades of design history. We reclaim unique streetwear, distressed heavy cottons, and high-drape garments that possess character. Every piece is cleaned, measured, and verified before drop release.
          </p>
          ...
          {emailSubscribed ? (
            ...
            <form onSubmit={handleSubscribe} className="w-full max-w-md flex items-center border border-[#F0EFE7]/10 focus-within:border-[#B8A98F] rounded-full p-1 transition-all bg-[#0c0c0c]/40 mt-4">
              <input 
                ...
                className="w-full bg-transparent text-[10px] tracking-widest font-light py-2 px-4 border-none outline-none text-[#F0EFE7] placeholder-[#F0EFE7]/30"
                required
              />
              <button 
                type="submit" 
