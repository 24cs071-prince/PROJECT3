...
export default function ProfilePage() {
  ...
  const activeOrders = ordersHistory && ordersHistory.length > 0 ? ordersHistory : (MOCK_ORDERS as any[]).filter((o: any) => o.userId === activeUser.id || o.email === activeUser.email);
      ...
      {selectedOrder && (
        <div className="print-only text-black bg-white p-8 font-sans">
          ...
          <div className="border-b-2 border-black pb-6 mb-8 flex justify-between items-end">
            <div>
              <h1 className="font-serif text-3xl font-black tracking-wider uppercase">Lunar Thrift</h1>
          ...
          <div className="grid grid-cols-2 gap-8 mb-8 text-xs text-left">
            ...
            <div>
              ...
              <p className="font-semibold text-sm">Lunar Thrift Celestial Vaults</p>
          ...
          <div className="mt-16 text-center text-[10px] text-gray-400 border-t border-gray-200 pt-6">
            <p className="uppercase tracking-widest font-semibold mb-1">Thank you for acquiring from Lunar Thrift</p>
